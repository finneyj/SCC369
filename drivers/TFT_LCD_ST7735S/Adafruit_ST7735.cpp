...
/*!
    ...
    @param  cs   Chip select pin (edge connector number)
    @param  dc   Data/Command pin (edge connector number)
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7735::Adafruit_ST7735(int8_t cs, int8_t dc, int8_t rst, int8_t mosi, int8_t miso, int8_t sclk)
    : Adafruit_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, mosi, sclk, rst, miso) {}
